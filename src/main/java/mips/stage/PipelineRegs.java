...
public class PipelineRegs {
    ...
    public static boolean lw1 = false;
    ...
    public static boolean lw2 = false;
    ...
    public static boolean lw3 = false;
    ...
    public static void store1(Word immsignex, int WR) {
        ...
        lw1 = ControlUnit.getLW(); // implementation for detecting read after load word
